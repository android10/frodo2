 ...
 */
public class SingleWeaver {

  public static final String POINTCUT =
      "execution(@com.fernandocejas.frodo2.annotation.RxLogSingle * *(..)) && if()";
  public static final String ADVICE = "methodAnnotatedWithRxLogSingle(joinPoint)";
  ...
  public Object weaveAroundJoinPoint(ProceedingJoinPoint joinPoint, Logger logger)
    ...
    return new FrodoForSingle(proceedingJoinPoint, messageManager).single();
  }
}
