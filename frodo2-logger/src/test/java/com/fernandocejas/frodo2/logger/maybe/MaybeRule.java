...
class MaybeRule implements TestRule {
  ...
  @Override public Statement apply(Statement statement, Description description) {
    ...
    rxComponentInfo = new RxComponentInfo(RxComponent.MAYBE, frodoProceedingJoinPoint);
